...
//
//  MusicPlayerListVC.swift
//  music app
//
//  Created by Rossitek1 on 21/03/18.
//  Copyright © 2018 Rossitek. All rights reserved.
//
...
import MediaPlayer
import AVFoundation
class MusicPlayerListVC: UIViewController,MPMediaPickerControllerDelegate, UITableViewDelegate,UITableViewDataSource {
...
//
        if  let imageSound: MPMediaItemArtwork = item.value( forProperty: MPMediaItemPropertyArtwork ) as? MPMediaItemArtwork {
            ...
            cell.imageMusic.layer.cornerRadius = 5
            cell.imageMusic.layer.masksToBounds = true
            cell.imageMusic.clipsToBounds = true
        }
        return cell;
    }
